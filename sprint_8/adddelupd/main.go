...
func main() {
	...
	newClient := Client{
		FIO:      "kkk aa kk",   // укажите ФИО
		Login:    "kak",         // укажите логин
		Birthday: "080808",      // укажите день рождения
		Email:    "kak@kak.com", // укажите почту
	}
	...
	newLogin := "klelele" // укажите новый логин
...
func insertClient(db *sql.DB, client Client) (int64, error) {
	...
	ident, err := res.LastInsertId()
	if err != nil {
		return 0, err
	}

	return ident, nil // вместо 0 верните идентификатор добавленной записи
}
